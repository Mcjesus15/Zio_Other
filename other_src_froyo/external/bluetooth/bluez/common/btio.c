...
//Daniel++ 20101028, BUG918, [KB62][Bluetooth][Froyo]Merge BT IOT Honda JCI no music heard from Carkit
//RICHARDLEE++    //Maximum Transmission Unit size is too big
#define BUFFER_SIZE 2048 // equal size to BUFFER_SIZE in liba2dp.c
#define CCI_MTU_SIZE (BUFFER_SIZE/2)
//RICHARDLEE--
//Daniel--
struct set_opts {
	bdaddr_t src;
...
//Daniel++ 20101028, BUG918, [KB62][Bluetooth][Froyo]Merge BT IOT Honda JCI no music heard from Carkit
//RICHARDLEE++    //Maximum Transmission Unit size is too big
	if(BUFFER_SIZE < l2o.imtu) l2o.imtu = CCI_MTU_SIZE;
	if(BUFFER_SIZE < l2o.omtu) l2o.omtu = CCI_MTU_SIZE;
//RICHARDLEE--
//Daniel --
