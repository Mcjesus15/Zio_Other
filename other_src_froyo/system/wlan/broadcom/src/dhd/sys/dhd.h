...
/* DRIVER default settings is STOP or START */
extern int dhd_wlan_reset_off;
...
//#if 0 //Bruno
	...
	#define SPINWAIT_SLEEP(a, exp, us)  do { \
		...
		printk("Exit SPINWAIT_SLEEP, countdown = %d\n", countdown); \
	} while (0)
...
extern void dhd_sdclk_timer(void *bus, uint wdtick); //Bruno, 20100806, Bug605, Implement OOB interrupt
...
/* ya_nakamura added 2010/08/24
   SDIO clk off timer reset and resetting ( 3sec. ) */
void dhd_sdclk_timer_driver_intial_setting(dhd_pub_t *dhdp);
