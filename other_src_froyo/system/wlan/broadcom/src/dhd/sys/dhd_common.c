...
char nv_path[MOD_PARAM_PATHLEN]="/etc/Nvram.txt\0"; //vivien@cci modify
...
#ifdef CONFIG_BCM4325_FW_PATH
DHD_ERROR (("%s: CONFIG_BCM4325_FW_PATH=%s\n", __FUNCTION__, CONFIG_BCM4325_FW_PATH));
	strncpy(fw_path, CONFIG_BCM4325_FW_PATH, MOD_PARAM_PATHLEN-1);
#else
	//fw_path[0] = '\0';
	strncpy(fw_path, "/etc/rtecdc.bin\0", MOD_PARAM_PATHLEN-1);
#endif
#ifdef CONFIG_BCM4325_NVRAM_PATH
DHD_ERROR (("%s: CONFIG_BCM4325_NVRAM_PATH=%s\n", __FUNCTION__, CONFIG_BCM4325_NVRAM_PATH));
	strncpy(nv_path, CONFIG_BCM4325_NVRAM_PATH, MOD_PARAM_PATHLEN-1);
#else
	//nv_path[0] = '\0';
